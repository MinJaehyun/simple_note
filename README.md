...
- (대기) 메모 내용 음성으로 읽기: api 있음
- (대기) 위와 반대로 음성을 녹음해서 text로 작성해주는 기능
...
- ㄴ 내용 입력한 상태에서 하단 저장 버튼 클릭 시, 중앙에 dialog로 ai 답변 띄우고, 
- ㄴ dialog 하단에 3가지 버튼 띄운다. 
- ㄴ 기능: "이대로 저장" / "ai 답변 복사" / "창 닫기"
- ㄴ 1번: 이대로 저장: 제목, 내용, 등등 그대로 저장한다
- ㄴ 2번: ai 답변 복사: 중앙에 dialog 띄우고, 작성한 내용
- ㄴ 3번: 창 닫기: Get.back();

- 퀴즈 저장: 이미지 등록 버튼 좌측에 퀴즈 버튼 만들고, 클릭 시, dialog로 퀴즈 내용 뛰우기
- "퀴즈 저장" / "창 닫기"
- 퀴즈는 대표 이미지 밑에 위치한다 (여러 개의 퀴즈를 가로로 페이지 넘겨서 볼 수 있다)
